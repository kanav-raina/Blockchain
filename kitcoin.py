...
class Blockchain:
    ...
    def proof_of_work(self,previous_proof):
        ...
        while check_proof is False:
            hash_operation=hashlib.sha256(str(new_proof**2-previous_proof**2).encode()).hexdigest()   #hash operation has to be unsymmetrical 
...
def add_transaction():
    json=request.get_json()                                                           #return the postman request in json format
...
def connect_node():
    ...
    response={'message':'All the nodes are now connected ,The kitcoin  Blockchain now contains the:',
